...
/**
 * Protocol for secret key related operations, to be used by the Custos
 * auth service role.
 */
@ProtocolInfo(protocolName =
    "org.apache.hadoop.hdds.protocol.SecretKeyProtocolCustos",
    protocolVersion = 1)
@KerberosInfo(
    serverPrincipal = HDDS_SCM_KERBEROS_PRINCIPAL_KEY,
    clientPrincipal = "ozone.custos.kerberos.principal"
)
public interface SecretKeyProtocolCustosPB extends
