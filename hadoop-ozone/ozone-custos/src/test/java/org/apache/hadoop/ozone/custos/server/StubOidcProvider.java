...
/**
 * Test-only {@link CustosProvider} for {@link CredentialType#OIDC_JWT}. Echoes
 * the {@code subject} attribute back as the authenticated identity.
 */
public class StubOidcProvider implements CustosProvider {
